...
import { MessageCircle, AlertCircle, CheckCircle2, Loader2, Sparkles, CheckCheck } from 'lucide-react';
...
export default function WhatsAppCheckerCard({ onAnalyze }: WhatsAppCheckerCardProps) {
  ...
  const handleAnalyze = () => {
    ...
    setIsAnalyzing(true);
    setTimeout(() => {
      const isScam = /won|prize|claim|lakh|crore|http|link|whatsapp/i.test(waText);
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">Paste your WhatsApp message</p>
          </div>
        </div>

        {/* WhatsApp Chat Bubble Input */}
